...
def load_mapillary_vistas_json():
    with open("datasets/mapillary_list/val_dict.json") as f:
        dataset_dicts = json.load(f)
    return dataset_dicts


def register_mapillary_vistas(
    name,
    metadata,
    image_root,
    semantic_root,
...
def register_all_mapillary_vistas(root):
    ...
    ) in _PREDEFINED_SPLITS_MAPILLARY_SEMANTIC.items():
