...
def add_clouds_config(cfg):
    ...
    cfg.MODEL.CLOUDS.CLASSICAL_INFERENCE = False
    cfg.MODEL.CLOUDS.CLASSICAL_INFERENCE_EMA = False
...
def add_prerocessing_training_set_config(cfg):
    cfg.INPUT.FLIP = True
    ...
    cfg.DATASETS.TARGET_FACTOR = 1.0
