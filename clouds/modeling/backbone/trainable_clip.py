...
class TrainableCLIP(Backbone):
    def __init__(self, cfg, input_shape):
        super().__init__()
        model_name = cfg.MODEL.CLOUDS.CLIP_MODEL_NAME
        pretrained = cfg.MODEL.CLOUDS.CLIP_PRETRAINED_WEIGHTS
    ...
    def extract_features_convnext(self, x):
        ...
        for i in range(4):
            ...
            out[
                f"res{i+2}"
            ] = x.contiguous()  # res 2 (os4), 3 (os8), 4 (os16), 5 (os32)
